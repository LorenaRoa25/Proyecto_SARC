...
def build_document():
    ...
    number(doc, "El usuario abre http://localhost:8000/index.html.")
...
""",
    ...
    doc.add_paragraph(
        "La funcion primero intenta iniciar sesion. Si Firebase responde que el usuario no existe, lo crea automaticamente. "
